...
function InitAllyPriorities takes nothing returns nothing
    ...
    call SetStartLocPrio(6, 7, 8, MAP_LOC_PRIO_LOW)
    call SetStartLocPrio(6, 8, 9, MAP_LOC_PRIO_LOW)
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(6, - 1664.0, 512.0)
